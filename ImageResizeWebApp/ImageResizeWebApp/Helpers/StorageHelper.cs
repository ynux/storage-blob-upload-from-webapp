...
namespace ImageResizeWebApp.Helpers
{
    public static class StorageHelper
    {
        ...
        public static async Task<List<string>> GetDocUrls(AzureStorageConfig _storageConfig)
        {
            List<string> documentUrls = new List<string>();

            // Create a URI to the storage account, https://blobtriggerstac.blob.core.windows.net/test/3OV8QR.pdf
            Uri accountUri = new Uri("https://" + _storageConfig.AccountName + ".blob.core.windows.net/");
